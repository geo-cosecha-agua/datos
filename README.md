...
ogrinfo geo/textura/uso-suelo.shp -dialect SQLite -sql "UPDATE textura SET uso_suelo = '' WHERE textura_id = 1"
ogrinfo geo/textura/uso-suelo.shp -dialect SQLite -sql "UPDATE textura SET uso_suelo = 'Bosque latifoliado abierto' WHERE textura_id = 2"
ogrinfo geo/textura/uso-suelo.shp -dialect SQLite -sql "UPDATE textura SET uso_suelo = 'Tacotal' WHERE textura_id = 3"
ogrinfo geo/textura/uso-suelo.shp -dialect SQLite -sql "UPDATE textura SET uso_suelo = 'Bosque latifoliado cerrado' WHERE textura_id = 4"
ogrinfo geo/textura/uso-suelo.shp -dialect SQLite -sql "UPDATE textura SET uso_suelo = 'Cultivos perennes' WHERE textura_id = 5"
ogrinfo geo/textura/uso-suelo.shp -dialect SQLite -sql "UPDATE textura SET uso_suelo = 'Cultivos anuales' WHERE textura_id = 6"
ogrinfo geo/textura/uso-suelo.shp -dialect SQLite -sql "UPDATE textura SET uso_suelo = 'Pasto' WHERE textura_id = 7"
ogrinfo geo/textura/uso-suelo.shp -dialect SQLite -sql "UPDATE textura SET uso_suelo = 'Vegetación arbustiva' WHERE textura_id = 8"
ogrinfo geo/textura/uso-suelo.shp -dialect SQLite -sql "UPDATE textura SET uso_suelo = 'Bosque de pino abierto' WHERE textura_id = 9"
ogrinfo geo/textura/uso-suelo.shp -dialect SQLite -sql "UPDATE textura SET uso_suelo = 'Agua' WHERE textura_id = 10"
ogrinfo geo/textura/uso-suelo.shp -dialect SQLite -sql "UPDATE textura SET uso_suelo = 'Suelo sin vegetación' WHERE textura_id = 11"
ogrinfo geo/textura/uso-suelo.shp -dialect SQLite -sql "UPDATE textura SET uso_suelo = 'Centros poblados' WHERE textura_id = 12"
ogrinfo geo/textura/uso-suelo.shp -dialect SQLite -sql "UPDATE textura SET uso_suelo = 'Bosque de pino cerrado' WHERE textura_id = 13"
ogrinfo geo/textura/uso-suelo.shp -dialect SQLite -sql "UPDATE textura SET uso_suelo = 'Vegetación herbacea' WHERE textura_id = 14"
ogrinfo geo/textura/uso-suelo.shp -dialect SQLite -sql "UPDATE textura SET uso_suelo = 'Tierras sujetas a inundación' WHERE textura_id = 15"
ogrinfo geo/textura/uso-suelo.shp -dialect SQLite -sql "UPDATE textura SET uso_suelo = 'Manglar' WHERE textura_id = 16"
