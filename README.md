...
ogrinfo geo/uso-suelo/uso-suelo.shp -sql "ALTER TABLE uso_suelo ADD COLUMN uso_suelo character(20)"
ogrinfo geo/uso-suelo/uso-suelo.shp -dialect SQLite -sql "UPDATE uso_suelo SET uso_suelo = '' WHERE uso_id = 1"
ogrinfo geo/uso-suelo/uso-suelo.shp -dialect SQLite -sql "UPDATE uso_suelo SET uso_suelo = 'Bosque latifoliado abierto' WHERE uso_id = 2"
ogrinfo geo/uso-suelo/uso-suelo.shp -dialect SQLite -sql "UPDATE uso_suelo SET uso_suelo = 'Tacotal' WHERE uso_id = 3"
ogrinfo geo/uso-suelo/uso-suelo.shp -dialect SQLite -sql "UPDATE uso_suelo SET uso_suelo = 'Bosque latifoliado cerrado' WHERE uso_id = 4"
ogrinfo geo/uso-suelo/uso-suelo.shp -dialect SQLite -sql "UPDATE uso_suelo SET uso_suelo = 'Cultivos perennes' WHERE uso_id = 5"
ogrinfo geo/uso-suelo/uso-suelo.shp -dialect SQLite -sql "UPDATE uso_suelo SET uso_suelo = 'Cultivos anuales' WHERE uso_id = 6"
ogrinfo geo/uso-suelo/uso-suelo.shp -dialect SQLite -sql "UPDATE uso_suelo SET uso_suelo = 'Pasto' WHERE uso_id = 7"
ogrinfo geo/uso-suelo/uso-suelo.shp -dialect SQLite -sql "UPDATE uso_suelo SET uso_suelo = 'Vegetación arbustiva' WHERE uso_id = 8"
ogrinfo geo/uso-suelo/uso-suelo.shp -dialect SQLite -sql "UPDATE uso_suelo SET uso_suelo = 'Bosque de pino abierto' WHERE uso_id = 9"
ogrinfo geo/uso-suelo/uso-suelo.shp -dialect SQLite -sql "UPDATE uso_suelo SET uso_suelo = 'Agua' WHERE uso_id = 10"
ogrinfo geo/uso-suelo/uso-suelo.shp -dialect SQLite -sql "UPDATE uso_suelo SET uso_suelo = 'Suelo sin vegetación' WHERE uso_id = 11"
ogrinfo geo/uso-suelo/uso-suelo.shp -dialect SQLite -sql "UPDATE uso_suelo SET uso_suelo = 'Centros poblados' WHERE uso_id = 12"
ogrinfo geo/uso-suelo/uso-suelo.shp -dialect SQLite -sql "UPDATE uso_suelo SET uso_suelo = 'Bosque de pino cerrado' WHERE uso_id = 13"
ogrinfo geo/uso-suelo/uso-suelo.shp -dialect SQLite -sql "UPDATE uso_suelo SET uso_suelo = 'Vegetación herbacea' WHERE uso_id = 14"
ogrinfo geo/uso-suelo/uso-suelo.shp -dialect SQLite -sql "UPDATE uso_suelo SET uso_suelo = 'Tierras sujetas a inundación' WHERE uso_id = 15"
ogrinfo geo/uso-suelo/uso-suelo.shp -dialect SQLite -sql "UPDATE uso_suelo SET uso_suelo = 'Manglar' WHERE uso_id = 16"
